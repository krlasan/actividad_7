...
public class Worker extends AsyncTask <Uri, Void, Bitmap>  {
    ...
    protected Bitmap doInBackground(Uri... uris) {
        ...
        if(this.imageView.get().setImageBitmap(bitmap) != null && uris.length > 0){
            ...
            try {
                ...
                bitmap = ImageUtils.getScaledBitmapFromUri(this.imageView.get().setImageBitmap(bitmap),imageUri, IMAGE_WIDTH);
    ...
    protected void onPostExecute(Bitmap bitmap) {
        ...
        if (this.imageView.get().setImageBitmap(bitmap) != null && bitmap != null){
